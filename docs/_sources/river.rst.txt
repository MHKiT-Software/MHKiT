...
Long-term discharge data from a river gauging stations located within the vicinity of the project site can often be used for resource assessment. 
...
The river module contains a functionality for reading historical discharge data published by USGS. 
