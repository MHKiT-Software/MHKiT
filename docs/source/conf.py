...
project = "MHKiT"
copyright = "2026, National Laboratory of the Rockies, Pacific Northwest National Laboratory, and Sandia National Laboratories"
...
bibtex_bibfiles = ["MHKiT-Python.bib", "MHKiT-MATLAB.bib"]
...
latex_documents = [
    (master_doc, "MHKiT.tex", "MHKiT Documentation", "MHKiT Developers", "manual"),
]
...
man_pages = [(master_doc, "MHKiT", "MHKiT Documentation", "MHKiT Developers", 1)]
...
texinfo_documents = [
    (master_doc, "MHKiT", "MHKiT Documentation", "MHKiT Developers", "MHKiT"),
]
